...
#define STRING_CONFIG_H_AUTHOR "(Jack Moffitt, E3D BigBxo Pro)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define  DEFAULT_Ki 01.81
  #define  DEFAULT_Kd 79.67
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 180, 1600, 304 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 6, 50 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define FRONT_PROBE_BED_POSITION (MIN_PROBE_EDGE <= Y_PROBE_OFFSET_FROM_EXTRUDER ? Y_PROBE_OFFSET_FROM_EXTRUDER : MIN_PROBE_EDGE)
